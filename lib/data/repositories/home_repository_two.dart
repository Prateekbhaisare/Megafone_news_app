  ...
  Future<List<ArticleModelTwo>> fetchListTwo() async{
    ...
    try{
      final response = await http.get(Uri.parse(
        'https://newsapi.org/v2/everything?q=tesla&from=2025-03-11&sortBy=publishedAt&apiKey=92db6e64fa274d74a61d50776ab09b2d'
      ));
      if(response.statusCode == 200){
        ...
        List<ArticleModelTwo> articleListTwo = articles.map((e){
          return ArticleModelTwo(
            ...
            descriptionTwo: e['description'] ?? 'No Decription',
      ...
      // yadi net on nhi he toh data hive se aajyga
      var box = await getBox();
